...
public class SearchPaginatedProductsByCategoryHandler : IRequestHandler<SearchPaginatedProductsByCategoryCommand, SearchPaginatedProductsByCategoryResult>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        PaginationQueryResult<Product> productsPaginationResult = await _productRepository.ListPaginatedByCategoryNameAsync(request.CategoryName, request, cancellationToken);
